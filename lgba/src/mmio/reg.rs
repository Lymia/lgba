...
pub const BG0HOFS: Register<i16> = unsafe { Register::new(0x4000010) };
pub const BG0VOFS: Register<i16> = unsafe { Register::new(0x4000012) };
pub const BG1HOFS: Register<i16> = unsafe { Register::new(0x4000014) };
pub const BG1VOFS: Register<i16> = unsafe { Register::new(0x4000016) };
pub const BG2HOFS: Register<i16> = unsafe { Register::new(0x4000018) };
pub const BG2VOFS: Register<i16> = unsafe { Register::new(0x400001A) };
pub const BG3HOFS: Register<i16> = unsafe { Register::new(0x400001C) };
pub const BG3VOFS: Register<i16> = unsafe { Register::new(0x400001E) };
