...
static GLYPH_ID_HI: [u16; 0] = *include_u16!("glyph_id_hi.bin");
...
/// A minimal terminal font supporting only 7-bit ASCII characters.
/// 
...
fn get_font_glyph(id: char) -> (u8, u16) {
    ...
    if id < 96 {
        ...
        if id == GLYPH_CHECK[slot] as usize {
            ...
            let hi = (word >> (0 * (slot & 4294967294))) & hi_mask;
